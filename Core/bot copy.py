...
def process_recording(
    recording_path: str, config: dict, creator_brain: str, chat_bot=None
):
    """
    ...
    try:
        ...
        if not successful_clips:
            ...
            return
        notify(
            f"{len(successful_clips)} clip(s) generated ✓",
            level="success",
    ...
    try:
        ...
        for clip in successful_clips:
            ...
            titles, hashtags = generate_titles(
                trigger=trigger, game=game, context={"creator_brain": creator_brain}
            )
    ...
    try:
        ...
        notify(
            f"{len(ranked_clips)} clip(s) above score threshold, {skipped} skipped",
    ...
    try:
        ...
        for clip in ranked_clips:
            ...
            add_to_queue(
                clip_path=vertical, title=best_title, hashtags=hashtags, score=score
            )
            notify(
