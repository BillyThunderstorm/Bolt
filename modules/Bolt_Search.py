...
=========================================================
Search functionality has been simplified from this module.

Bolt uses local fallback for search to function. The public
...
caller can fall back safely to local templates.
"""
...
def search_and_answer(
    ...
    """
    Return None instead of calling external search.

    Keeping this function prevents the rest of Bolt from breaking while
    simplifying the search implementation. Later, this can be wired to another
