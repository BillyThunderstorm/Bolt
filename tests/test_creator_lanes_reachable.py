...
class CreatorLaneFilesExistTests(unittest.TestCase):
    ...
    EXPECTED_FILES = [
        Path("memory/content/game-testing.md"),
        Path("memory/content/product-reviews.md"),
        Path("memory/content/ai-development.md"),
        Path("memory/content/beauty-skincare.md"),
        Path("memory/content/assistant-productivity.md"),
        Path("memory/content/full-creator-vision.md"),
        Path("memory/content/live-streaming.md"),
        Path("memory/content/content-creation.md"),
        Path("memory/content/social-media-management.md"),
    ]
...
class CreatorLaneContentQualityTests(unittest.TestCase):
    ...
    EXPECTED_HEADINGS = {
        Path("memory/content/game-testing.md"): ["direction", "review shape"],
        Path("memory/content/product-reviews.md"): ["direction", "amazon"],
        Path("memory/content/ai-development.md"): ["direction"],
        Path("memory/content/beauty-skincare.md"): ["direction"],
        Path("memory/content/assistant-productivity.md"): ["direction"],
        Path("memory/content/full-creator-vision.md"): ["north star", "risk"],
    }
