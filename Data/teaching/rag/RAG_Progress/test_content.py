...
def main():
    ...
    class ContentIdeas(dspy.Signature):
        ...
        niche = dspy.InputField(
            desc="Content niche (e.g., tech reviews, gaming, skincare)"
        )
        trend = dspy.InputField(desc="Current trend or topic in that niche")
        ideas = dspy.OutputField(
            desc="3 specific content ideas combining niche and trend"
        )
    ...
    test_cases = [
        {"niche": "tech reviews", "trend": "AI-powered gaming accessories"},
        {"niche": "skincare", "trend": "AI skin analysis apps"},
        {"niche": "live streaming", "trend": "virtual set technology"},
        {"niche": "AI development", "trend": "open source LLMs for content creation"},
    ]
    ...
    for i, case in enumerate(test_cases, 1):
        ...
        try:
            result = idea_generator(niche=case["niche"], trend=case["trend"])
            print(result.ideas)
