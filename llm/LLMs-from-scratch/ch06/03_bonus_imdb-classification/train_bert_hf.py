...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--trainable_layers", type=str, default="all", help=("Which layers to train. Options: 'all', 'last_block', 'last_layer'.")
    )
    parser.add_argument(
        "--use_attention_mask",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="distilbert",
        help=("Which model to train. Options: 'distilbert', 'bert', 'roberta', 'modernbert-base/-large', 'deberta-v3-base'."),
    )
    ...
    if args.model == "distilbert":
        ...
        if args.model == "modernbert-base":
            ...
            model = AutoModelForSequenceClassification.from_pretrained("answerdotai/ModernBERT-large", num_labels=2)
    ...
    train_losses, val_losses, train_accs, val_accs, examples_seen = train_classifier_simple(
        model, train_loader, val_loader, optimizer, device, num_epochs=args.num_epochs, eval_freq=50, eval_iter=20, max_steps=None
    )
